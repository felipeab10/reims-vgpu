...
- [-] [T002 — Simplificar o VM Manager para fluxo de appliance](T002-vm-manager-appliance.md) — estática/controlada PASS; storage e chunklist non-TTY resolvidos; pronta para retry runtime
