...
- [-] [T002 — Simplificar o VM Manager para fluxo de appliance](T002-vm-manager-appliance.md) — implementação parcial; static/control/launcher PASS; OpenCore image validation pendente
