...
- [-] [T002 — Simplificar o VM Manager para fluxo de appliance](T002-vm-manager-appliance.md) — estática/controlada PASS; OpenCore dedicado e progresso validados; pronta para runtime
